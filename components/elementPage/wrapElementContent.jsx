              ...
              <div className="body__card-wrapper mb-30">
                ...
                <div className="input__field-wrapper mt-35">
                  ...
                  <div className="warning__field mb-15">
                    ...
                    <span className="input__alert alert-bg-1">
                      <span>Warning:</span> This fild can not be empty
                    </span>
                  </div>
                  <div className="warning__field mb-15">
                    <label className="input__field-text">
                    ...
                    <span className="input__alert alert-bg-2">
                      <span>Warning:</span> This fild can not be empty
                    </span>
                  </div>
                  <div className="warning__field mb-15">
                    ...
                    <span className="input__alert alert-bg-3">
                      <span>Warning:</span> This fild can not be empty
                    </span>
                  </div>
                </div>
                  ...
                  <div className="butttons__element-wrapper mt-35">
                    <div className="button__grid-wrapper">
                      <div className="fill__button-inner">
                        <a className="element__btn red-bg" href="#">
                          Home
                        </a>
                        <a className="element__btn perple-bg" href="#">
                          Home
                        </a>
                        <a className="element__btn yellow-bg" href="#">
                          Home
                        </a>
                        <a className="element__btn pink-bg" href="#">
                          Home
                        </a>
                        <a className="element__btn blue-bg" href="#">
                          Home
                        </a>
                        <a className="element__btn green-bg" href="#">
                          Home
                        </a>
                      </div>
                      <div className="border__button-inner">
                        <a className="element__btn border-red" href="#">
                          Home
                        </a>
                        <a className="element__btn border-perple" href="#">
                          Home
                        </a>
                        <a className="element__btn border-yellow" href="#">
                          Home
                        </a>
                        <a className="element__btn border-pink" href="#">
                          Home
                        </a>
                        <a className="element__btn border-blue" href="#">
                          Home
                        </a>
                        <a className="element__btn border-green" href="#">
                          Home
                        </a>
                      </div>
                    </div>
