...
const SchduleDetailsContent = ({schduleItem}) => {
                ...
                <div className="body__card-wrapper mb-20">
                  <div className="review__demo-wrapper">
                    <div className="review__demo-thumb w-img mb-25">
                      <img src={evnet_details_img.src} alt="image not found" />
...
export default SchduleDetailsContent;
