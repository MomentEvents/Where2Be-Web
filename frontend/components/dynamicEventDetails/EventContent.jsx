...
import evnet_details_img from "../../public/assets/img/event/event-details.jpg"
const EventContent = ({schduleItem}) => {
                  ...
                  <div className="review__main-wrapper pt-25">
                    ...
                    <div className="review__author-meta mb-15">
                      <div className="review__author-thumb">
                        <img src={schduleItem.userImg.src} alt="image not found" />
                      </div>
                      <div className="review__author-name">
                        <h4> {schduleItem.name} </h4>
                      </div>
                    </div>
                      ...
                      <div className="tab-content" id="nav-tabContent">
                        ...
                        >
                          <div className="about__event-thumb w-img mt-40">
                            <img src={schduleItem.thumbnail.src} alt="image not found" />
                          </div>
                          <div className="about__content mt-30">
                            <h4> {schduleItem.title} </h4>
                            <p>
                          ...
                          <div className="ticket__purchase-wrapper mt-30">
                            <h4 className="ticket__purchase-title">
                              Purchase Ticket
                            </h4>
                            <div className="ticket__price-inner">
                              <div className="ticket__price-item">
                                <label className="input__field-text">
                                  Sit Abailable
                                </label>
                                <div className="contact__select">
                                  <select>
                                    <option defaultValue="0"> {schduleItem.progress} </option>
